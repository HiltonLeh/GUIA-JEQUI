...
public class CompanyDetails extends BaseActivity implements OnClickListener,ImageGetter {
...
//       imgloader =  new ImageLazyLoader(this,Quality.HIGH);
	...
	public void onClick(View v) {
		...
		case R.id.btnback:
			...
			break;
		case R.id.button1:
			intent=new Intent(CompanyDetails.this,MainActivity.class);
		...
		case R.id.textView4:
			...
			intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://"+companyMap.get("website")));
				...
				Toast.makeText(this,"Sem oferta no momento!", Toast.LENGTH_LONG).show();
			break;
	...
	//		break;
		case R.id.btnhome:
			Intent intent1=new Intent(CompanyDetails.this,MainActivity.class);
